  ...
  <div class="layout-topbar">
    <div class="layout-topbar-logo-container">
      ...
      <Link href="/dashboard" class="layout-topbar-logo flex items-center gap-2">
        <img src="/imagenes/logoB.jpg" alt="Admin Logo" class="h-8 w-8 rounded-md object-cover" />
          <span class="font-serif text-base font-semibold">Sistema de Inscripciones y gestion INIF 48</span>
      </Link>
    </div>
